            ...
            @forelse($events as $event)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if($event->approved_registrations_count >= $event->quota)
                            <div style="margin-top:4px; font-size: 0.72rem; color: #dc2626; font-weight: 700; display: flex; align-items: center; gap: 4px; background: #fee2e2; padding: 2px 6px; border-radius: 4px; display: inline-flex;">
