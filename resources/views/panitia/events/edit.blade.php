...
@section('page-breadcrumb', '<a href="' . route('panitia.events.index') . '" style="color:#94a3b8;">Event</a> / <span>Edit</span>')
...
<div style="max-width:720px;">
    <div class="form-card">
        <div class="form-card-header">
            <h3>✏️ Edit Event: <span style="color:#0056B3;">{{ $event->title }}</span></h3>
        ...
        <div class="form-card-body">
            <form method="POST" action="{{ route('panitia.events.update', $event) }}" enctype="multipart/form-data" id="form-edit-event">
                ...
                <div class="form-group">
                    ...
                    @if($event->poster)
                        <div style="margin-bottom:0.625rem;display:flex;align-items:center;gap:0.75rem;">
                            ...
                            <span style="font-size:0.78rem;color:#64748b;">Poster saat ini</span>
                        </div>
                    @endif
                ...
                <div style="display:flex;gap:0.75rem;">
                    <button type="submit" class="btn btn-primary" id="btn-update-event">
