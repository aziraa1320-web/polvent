...
@section('page-breadcrumb')
    <a href="{{ route('panitia.events.index') }}" style="color:#94a3b8;">Event</a> / <span>Buat Baru</span>
@endsection
    ...
    <div class="create-form-card">
        <div class="create-form-header">
            <div>
                ...
                <p>Isi formulir berikut untuk membuat event kampus</p>
            </div>
            <a href="{{ route('panitia.events.index') }}" class="btn btn-secondary btn-sm" style="background:rgba(255,255,255,0.15);color:white;border-color:rgba(255,255,255,0.3);">← Kembali</a>
        </div>
            ...
            <form method="POST" action="{{ route('panitia.events.store') }}" enctype="multipart/form-data" id="form-create-event">
                ...
                <div class="field-group">
                    ...
                    <select name="location" id="location" class="field-input {{ $errors->has('location') ? 'is-invalid' : '' }}">
                        ...
                        <option value="Aula Administrasi Bisnis" {{ old('location') == 'Aula Administrasi Bisnis' ? 'selected' : '' }}>Aula Administrasi Bisnis</option>
                    </select>
                ...
                <div class="info-box" style="margin-bottom:1.5rem;">
                    ...
                    <span>Event yang Anda buat hanya dapat dikelola oleh Anda sendiri. Mahasiswa dapat mendaftar setelah event dibuat dan akan tampil di beranda secara otomatis.</span>
                </div>
