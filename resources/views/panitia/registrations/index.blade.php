                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:0.4rem;flex-wrap:wrap;">
                                ...
                                @endif
                                <form method="POST" action="{{ route('panitia.registrations.destroy', $reg) }}" onsubmit="return confirm('Yakin ingin menghapus pendaftaran {{ $reg->user->name }} dari event {{ $reg->event->title }}?');">
                                    @csrf @method('DELETE')
