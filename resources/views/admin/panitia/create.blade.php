...
<div class="create-card">
    ...
    <div class="create-card-body">
        ...
        <form action="{{ route('admin.panitia.store') }}" method="POST">
            ...
            <div class="form-group">
                <label for="phone" class="form-label">No. WhatsApp Panitia <span style="color:red;">*</span></label>
                ...
                <div class="form-hint">
                    ...
                    <strong>Wajib diisi.</strong>&nbsp;Nomor ini digunakan untuk menerima kode OTP saat login. Format: 08xxx atau +628xxx.
                </div>
